...
The red component of the tri-color LED will be connected to pin 10, and the blue will be connnected to pin 9. We don't need the green part of the LED for this lab. The temperature sensor will be connected to analog pin A1.
